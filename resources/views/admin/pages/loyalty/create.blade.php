...
<h4>Create Loyalty Tier</h4>
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create New Loyalty Tier</h3>
                    ...
                    <form action="{{ route('loyalty.store') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('days_required') is-invalid @enderror" 
                                           id="days_required" name="days_required" value="{{ old('days_required') }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('bonus_percentage') is-invalid @enderror" 
                                               id="bonus_percentage" name="bonus_percentage" value="{{ old('bonus_percentage') }}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="e.g., Stay invested for 20 days without withdrawal and unlock an extra 20% bonus on your profit!">{{ old('description') }}</textarea>
                            @error('description')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Create Loyalty Tier
                            </button>
