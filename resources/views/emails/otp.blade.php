...
<head>
    ...
    <title>InvestPro Verification Code</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="margin: 0 0 30px 0; color: #6b7280; line-height: 1.6;">
                @switch($type)
                    @case('signup')
                        Thank you for choosing InvestPro! To complete your account registration, please use the verification code below.
                        @break
                    @case('login')
            ...
            <div class="warning">
                <p>🔒 <strong>Security Notice:</strong> Never share this code with anyone. InvestPro staff will never ask for your verification code.</p>
            </div>
        ...
        <div class="footer">
            <p>© {{ date('Y') }} InvestPro. All rights reserved.</p>
